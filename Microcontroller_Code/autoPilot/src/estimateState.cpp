...
static void LatLonAlt2NED_Fcn(double Lat, double Lon, double Alt, double r0_ECEF[3], double NED_C_ECEF[9], double *r_NED)
{
  ...
  t4 = cos(Lat * 3.1415926535897931 / 180.0);
  ...
  Serial.print((t4 * cos(t7) * t17));
  Serial.print(" ");
  Serial.print((t4 * sin(t7) * t17));
  Serial.print(" ");
  Serial.println((t9 * (Alt + t15 * 4.0408299984659148E+13)));
  // OVERFLOW ERROR HERE //
}
...
static void getMeasurementVector(double *Z, double *Z_input)
{
  ...
  // --- Z --- //
  double NED_C_ECEF[9] = {1, 0, 0, 0, 1, 0, 0, 0, 1};
  double r0_ECEF[3] = {3, 3, 3};
